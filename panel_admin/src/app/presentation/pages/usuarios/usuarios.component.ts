...
import { UsuarioHistorialComponent } from './usuario-historial.component';

type TipoDialogo = 'crear' | 'editar' | 'password' | 'historial';

@Component({
  selector: 'app-usuarios',
  standalone: true,
  imports: [UdiLoadingComponent, UdiEmptyComponent, UsuarioFormComponent, UsuarioPasswordComponent, UsuarioHistorialComponent],
...
export class UsuariosComponent implements OnInit, OnDestroy {
  ...
  abrirHistorial(usuario: UsuarioLista): void {
    this.seleccionado.set(usuario);
    this.dialogo.set('historial');
  }
