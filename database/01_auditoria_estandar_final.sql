...
END;
IF COL_LENGTH(N'dbo.Usuarios', N'FechaRegistro') IS NULL
    ALTER TABLE dbo.Usuarios ADD FechaRegistro DATETIME2(3) NOT NULL CONSTRAINT DF_Usuarios_FechaRegistro DEFAULT SYSUTCDATETIME();
IF COL_LENGTH(N'dbo.Usuarios', N'Estado') IS NULL
    ALTER TABLE dbo.Usuarios ADD Estado BIT NOT NULL CONSTRAINT DF_Usuarios_Estado DEFAULT 1;
...
END;
IF COL_LENGTH(N'dbo.Vehiculos', N'FechaRegistro') IS NULL
    ALTER TABLE dbo.Vehiculos ADD FechaRegistro DATETIME2(3) NOT NULL CONSTRAINT DF_Vehiculos_FechaRegistro DEFAULT SYSUTCDATETIME();
...
CREATE OR ALTER TRIGGER dbo.TR_TiposUsuario_Auditoria ON dbo.TiposUsuario AFTER INSERT, UPDATE, DELETE AS
BEGIN
    SET NOCOUNT ON;
...
CREATE OR ALTER TRIGGER dbo.TR_Roles_Auditoria ON dbo.Roles AFTER INSERT, UPDATE, DELETE AS
BEGIN
    SET NOCOUNT ON;
    IF TRIGGER_NESTLEVEL() > 1 RETURN;
    DECLARE @Ahora DATETIME2(3) = SYSUTCDATETIME();
...
CREATE OR ALTER TRIGGER dbo.TR_Usuarios_Auditoria ON dbo.Usuarios AFTER INSERT, UPDATE, DELETE AS
BEGIN
    SET NOCOUNT ON;
    IF TRIGGER_NESTLEVEL() > 1 RETURN;
    DECLARE @Ahora DATETIME2(3) = SYSUTCDATETIME();
...
CREATE OR ALTER TRIGGER dbo.TR_Vehiculos_Auditoria ON dbo.Vehiculos AFTER INSERT, UPDATE, DELETE AS
BEGIN
    SET NOCOUNT ON;
    IF TRIGGER_NESTLEVEL() > 1 RETURN;
    DECLARE @Ahora DATETIME2(3) = SYSUTCDATETIME();
...
CREATE OR ALTER TRIGGER dbo.TR_RegistrosPorteria_Auditoria ON dbo.RegistrosPorteria AFTER INSERT, UPDATE, DELETE AS
BEGIN
    SET NOCOUNT ON;
    IF TRIGGER_NESTLEVEL() > 1 RETURN;
    DECLARE @Ahora DATETIME2(3) = SYSUTCDATETIME();
...
CREATE OR ALTER TRIGGER dbo.TR_RegistrosParqueo_Auditoria ON dbo.RegistrosParqueo AFTER INSERT, UPDATE, DELETE AS
BEGIN
    SET NOCOUNT ON;
    IF TRIGGER_NESTLEVEL() > 1 RETURN;
    DECLARE @Ahora DATETIME2(3) = SYSUTCDATETIME();
...
CREATE OR ALTER TRIGGER dbo.TR_RefreshTokens_Auditoria ON dbo.RefreshTokens AFTER INSERT, UPDATE, DELETE AS
BEGIN
    SET NOCOUNT ON;
    IF TRIGGER_NESTLEVEL() > 1 RETURN;
    DECLARE @Ahora DATETIME2(3) = SYSUTCDATETIME();
