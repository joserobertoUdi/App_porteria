...
namespace ServiciosGenerales.Api.Controllers
{
    ...
    public class ParqueoController : ControllerBase
    {
        ...
        /// NameIdentifier del JWT (documento de identidad) para marcar quién
        /// aprueba cada ingreso (auditoría de guardia).
        /// </summary>
        ...
        {
            var resultado = await _entradaCompletaUseCase.Ejecutar(dto, await ObtenerOperadorIdActual());
            return Ok(new
            {
