...
namespace ServiciosGenerales.Aplicacion.UseCases.Parqueo
{
    ...
    {
        Task<EntradaCompletaResultado> Ejecutar(RegistrarEntradaParqueoCompletaDto dto);
    }
    ...
    public class RegistrarEntradaParqueoCompletaUseCase : IRegistrarEntradaParqueoCompletaUseCase
    {
        ...
        public async Task<EntradaCompletaResultado> Ejecutar(RegistrarEntradaParqueoCompletaDto dto)
        {
